...
class ChangeControl(Base):
    ...
    regulatory_filing_deadline: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    ...
    qualification_record_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    qualification_status: Mapped[str | None] = mapped_column(String(50), nullable=True)  # draft|approved|rejected
    ...
    retrospective_review_due_date: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
